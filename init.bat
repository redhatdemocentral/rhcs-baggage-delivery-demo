...
set DEMO=Cloud Baggage Delivery Demo
set AUTHORS=Jason Milliron, Andrew Block, Eric D. Schabell
set PROJECT=git@github.com:redhatdemocentral/rhcs-baggage-delivery-demo.git
...
set OCP_APP=rhcs-baggage-delivery
...
echo ==================================================================================
echo =                                                                                =
echo =  Login to start exploring the Baggage Delivery project:                        =
echo =                                                                                =
